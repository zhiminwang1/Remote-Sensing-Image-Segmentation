...
# 随机窗口采样
def generate_train_dataset(image_num = 20,
                           train_image_path='test/images/',
                           train_label_path='test/labels/'):
    '''
    ...
    # images_path = ['origin/test1.tif','origin/test2.tif','origin/test3.tif','origin/test4.tif','origin/test5.tif']
    # labels_path = ['origin/test1_label.tif','origin/test2_label.tif','origin/test3_label.tif','origin/test4_label.tif','origin/test5_label.tif']

    images_path = ['origin/test6.tif','origin/test7.tif']
    labels_path = ['origin/test6_label.tif','origin/test7_label.tif']
...
if __name__ == '__main__':
    # if not os.path.exists('train/images'): os.mkdir('train/images')
    # if not os.path.exists('train/labels'): os.mkdir('train/labels')
    if not os.path.exists('test/images'): os.mkdir('test/images')
    if not os.path.exists('test/labels'): os.mkdir('test/labels')
