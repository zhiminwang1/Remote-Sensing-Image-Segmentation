...
def cfamnaspp(height, width, channel, classes):
    ...
    attention1 = Conv2d_BN(conv5_3,256,1)
    attention1 = cfam_module(attention1,6,256,128)

    attention2 = Conv2d_BN(conv4_6,256,1)
    attention2 = cfam_module(attention2,6,256,128)

    x = Concatenate()([attention1,attention2])
    x = Conv2d_BN(x,128,1)
...
if __name__ == '__main__':
    model = cfamnaspp(height=128, width=128, channel=3, classes=6)
    model.summary()